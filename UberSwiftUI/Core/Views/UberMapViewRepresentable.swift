    ...
    func updateUIView(_ uiView: UIViewType, context: Context) {
        ...
        case .locationSelected:
            if let coordinate = homeViewModel.selectedUberLocation?.coordinate {
                ...
                context.coordinator.addAndSelectAnnotation(WithCpprdinate: coordinate)
        ...
        case .tripAccepted:
            ...
            context.coordinator.addAndSelectAnnotation(WithCpprdinate: trip.pickupLocation.toCoordinate())
        default:
            break
        }
    }
...
extension UberMapViewRepresentable {
    ...
    class MapCoordinator: NSObject, MKMapViewDelegate {
        ...
        var curreentRegion: MKCoordinateRegion?
        ...
        MKOverlayRenderer {
            let poleyline = MKPolylineRenderer(overlay: overlay)
            poleyline.strokeColor = .systemBlue
            poleyline.lineWidth = 6
            return poleyline
        }
        ...
        func addAndSelectAnnotation(WithCpprdinate coordinate: CLLocationCoordinate2D) {
        ...
        func configurePolyline(withDestinationCoordinate coordinate: CLLocationCoordinate2D) {
            ...
            parent.homeViewModel.getDestinationRoute(from: userLocationCoordinate,
                ...
                let rect = self.parent.mapView.mapRectThatFits(route.polyline.boundingMapRect,
                                                               edgePadding: .init(top: 64, left: 32, bottom: 500, right: 45))
                self.parent.mapView.setRegion(MKCoordinateRegion(rect), animated: true)
            }
        }
        ...
        func clearMapViewAndRecenterOnUserLocation() {
            ...
            if let curreentRegion = curreentRegion {
                parent.mapView.setRegion(curreentRegion, animated: true)
            }
        }
